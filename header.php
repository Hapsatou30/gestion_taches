...
<body>
    ...
    <aside class="col-md-3 bg-light">
        <div class="logo">
            <a href="home.php"><span>Tâche</span>Solution</a>
        </div>
        <nav aria-label="Barre de navigation">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="home.php"><i class="fas fa-home"></i> Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="profil.php"><i class="fas fa-user"></i> Profil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link logout" href="#"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
                </li>
            </ul>
        </nav>
